...
public class GameManagerListner : MonoBehaviourPunCallbacks
{
	...
	//public void PlayerDied(SP_PlayerStateManager player)
	//{
	//	if (didGameEnd() == false)
	//	{
	...
	//private void checkIfselectedUnitDied(SP_PlayerStateManager unit)
	//{
	//	SP_GameStateManager manager = SP_GameStateManager.Instance;
